                                        ...
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div v-if="errors.price">{{ errors.price }}</div><br>
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    <label for="is_selling" class="leading-7 text-sm text-gray-600">商品価格</label>
                                                    ...
                                                    <div v-if="errors.is_selling">{{ errors.is_selling }}</div><br>
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
