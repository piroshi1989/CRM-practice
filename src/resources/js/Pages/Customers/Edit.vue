                                        ...
                                        <div class="flex flex-wrap -m-2">
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div v-if="errors.name">{{ errors.name }}</div><br>
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div v-if="errors.kana">{{ errors.kana }}</div><br>
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div v-if="errors.tel">{{ errors.tel }}</div><br>
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div v-if="errors.name">{{ errors.email }}</div><br>
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div v-if="errors.name">{{ errors.postcode }}</div><br>
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div v-if="errors.name">{{ errors.address }}</div><br>
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div v-if="errors.name">{{ errors.birthday }}</div><br>
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div v-if="errors.is_selling">{{ errors.gender }}</div><br>
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <div v-if="errors.memo">{{ errors.memo }}</div><br>
                                                </div>
                                            </div>
